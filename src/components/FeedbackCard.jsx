...
const FeedbackCard = ({ content, name, title, img }) => (
  <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[400px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
    <img src={quotes} alt="double_quotes" className="w-[40px] h-[25px] object-contain" />
    <p className="font-nutino font-normal text-[18px] leading-[32.4px] text-white my-10">
      {content}
    </p>
    ...
    <div className="flex flex-row">
      ...
      <div className="flex flex-col ml-4">
        ...
        <p className="font-nutino font-normal text-[16px] leading-[24px] text-dimWhite">
          {title}
        </p>
      </div>
    </div>
